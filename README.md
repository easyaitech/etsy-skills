...
| [`logistics-tracking`](logistics-tracking/SKILL.md) | 跨境物流状态自动跟踪：用 17TRACK 把 `Orders 订单` 已发货单的跟踪号一路跟到签收，状态有变推飞书；register-once + 每日 standard 轮询，签收交回 orders-customers |
...
├── logistics-tracking/        # │ 物流跟踪（17TRACK，挂在 Orders 上跑）
├── supplier-foundation/       # │
