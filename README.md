...
```bash
curl -fsSL https://raw.githubusercontent.com/easyaitech/etsy-skills/v1.0.11/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/easyaitech/etsy-skills/v1.0.11/install.sh -o install.sh
...
| `ECOMMERCE_SKILLS_REF` | `main`（推荐传具体 tag，例如 `v1.0.11`） |
