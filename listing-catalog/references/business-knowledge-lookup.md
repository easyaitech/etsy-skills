...
- step 6/7 之前还没开始生成最终文案，卡片可以影响角度，但不会覆盖 BRAND.md / SHOP.md / Etsy SEO 规则。
...
sku_context:
  ...
  seo_keywords: eRank 词库、商品 Base SEO 关键词、etsy-seo 生成候选
...
```text
BRAND.md / SHOP.md
  -> Etsy policy and etsy-seo.md
  -> current user instruction
  -> gift-scenario.md
  -> Knowledge Cards
```

Knowledge Cards 只能提供角度和措辞参考，不能覆盖品牌红线、店铺政策、Etsy SEO 硬规则或用户当前明确要求。用户当前要求如果和品牌 / 店铺 / Etsy 硬约束冲突，按硬约束处理。
