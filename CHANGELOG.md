...
### 移除
- `trend-radar`：删除趋势雷达 skill、浏览器采集脚本、SerpApi fallback、报告 schema 和 `scripts/trend-radar-run`。趋势分析质量要求更高，未来统一通过 Claude CoWork 完成，不再在 Hermes skill 集合里维护低质量替代路径。
