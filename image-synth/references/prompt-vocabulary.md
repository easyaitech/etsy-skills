...
目标平台是小红书时，读取 `listing-catalog/references/xiaohongshu-commerce.md` 的商品图 / 使用指南图 / 图文详情图规则：
...
| 用途 | 长宽比 | 建议分辨率 | 备注 |
|---|---|---|---|
| 商品图 | 1:1 或 3:4 | 800 × 800 或 750 × 1000 | 以 `xiaohongshu-commerce.md` 和后台类目要求为准 |
