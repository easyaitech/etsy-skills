...
| 方法论知识 / 写作 SOP（如 listing 文案手艺） | `knowledge/wiki/` + Knowledge Cards（含拷入的种子；**evidence 非 instruction**，压不过平台硬规则与闸门） | `business-knowledge`；种子机制与两层冲突规则见 [`knowledge-seeds.md`](knowledge-seeds.md) |
